...
namespace UniVue.View.Views
{
    ...
    public sealed class SuperGridWidget : IWidget
    {
        ...
        public SuperGridWidget() { }

        public SuperGridWidget(GridWidget grid) 
        { 
            _grid = grid;
        }
        ...
        internal void Swap(Transform replaced, Transform target, Vector3 targetPos, SuperGridWidget targetOfGrid)
        {
    ...
    {
        private List<SuperGridWidget> _grids;
        ...
        /// 当前被拖拽元素进入的网格
        /// </summary>
        internal SuperGridWidget CurrentEnteredGrid { get; set; }
        ...
        internal void Add(SuperGridWidget grid)
        {
            _grids.Add(grid);
            if (_corners.Count < _grids.Count) { _corners.Add(new Vector3[4]); }
        }

        internal void Remove(SuperGridWidget remove)
        {
            _grids.Remove(remove); 
        }

        internal bool Contains(SuperGridWidget check)
        {
    ...
    internal class DraggableItem
    {
        ...
        /// 获取当前拖拽元素所属的
        /// </summary>
        public SuperGridWidget BelongsToGrid { get; set ; }
